    ...
    <center>
        <h2 style="margin-top:10px">NEW BOOKING DETAILS</h2>
        <br>
    </center>
    ...
    include("../database/config.php");
        $sql = "SELECT * FROM `roombooking_details` where `booking_status`='Waiting_for_confirmation'";
        get_Data($sql);
    ?>
            ...
            <table class="table table-bordered" id="table-data">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                                <a href="bookingconfirm.php?id= <?php echo $row[0]; ?>">
                                <button class="action">
                                Confirm</button>
                                </a>
                            </td>
