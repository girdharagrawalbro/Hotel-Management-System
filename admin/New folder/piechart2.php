...
<?php
    ...
    //roombook roomtype
    $chartroom1 = "SELECT * FROM roombook WHERE RoomType='Superior' and BOOKDATE between '2023-01-01' and '$todaydate'";
    $chartroom1re = mysqli_query($conn, $chartroom1);
    $chartroom1row = mysqli_num_rows($chartroom1re);

    $chartroom2 = "SELECT * FROM roombook WHERE RoomType='Deluxe' and BOOKDATE between '2023-01-01' and '$todaydate'";
    $chartroom2re = mysqli_query($conn, $chartroom2);
    $chartroom2row = mysqli_num_rows($chartroom2re);

    $chartroom3 = "SELECT * FROM roombook WHERE RoomType='Guest' and BOOKDATE between '2023-01-01' and '$todaydate'";
    $chartroom3re = mysqli_query($conn, $chartroom3);
    $chartroom3row = mysqli_num_rows($chartroom3re);

    $chartroom4 = "SELECT * FROM roombook WHERE RoomType='Single' and BOOKDATE between '2023-01-01' and '$todaydate'";
